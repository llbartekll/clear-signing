...
fn get_entry_value(entries: &[DisplayEntry], label: &str) -> String {
...
#[tokio::test]
async fn test_paraswap_v6_balancer_byte_slice_paths() {
    let descriptor = load_descriptor();
    let calldata = hex::decode("").unwrap();
    let tx = TransactionContext {
        chain_id: 1,
        to: "0x6a000f20005980200259b80c5102003040001068",
        calldata: &calldata,
        value: None,
        from: Some("0x2222222222222222222222222222222222222222"),
        implementation_address: None,
    };
    let provider = token_source();
    let descriptors = wrap_rd(descriptor, 1, "0x6a000f20005980200259b80c5102003040001068");
