...
import installer from './NativeClearSigning';
...
export * from './generated/clear_signing';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as clear_signing from './generated/clear_signing';
...
if (!initialized) {
  clear_signing.default.initialize();
  initialized = true;
}
